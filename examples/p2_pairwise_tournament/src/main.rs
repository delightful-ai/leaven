...
use leaven::{
    ...
    CachePolicy, CandidateId, ContentId, Cost, EvaluationRequest, Evaluator, Optimizer, PairOrder,
    Proposal, ProposalBatch, ProposalBatchSemantics, RunEvent,
};
                ...
                ProposalBatch {
                    proposals: vec![
                        Proposal::create(TextArtifact("aaa".to_owned()))
                            .informed_by([leaven::InfoRef::Candidate(self.seed)])
                            .build(),
                    ],
