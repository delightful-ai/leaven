...
STAGE_REQUIRED_FRAGMENTS = {
    ...
    "G3": [
        ...
        "change.log",
        "intermediates",
        "stage3_merge_prompts/{batch_id}.md",
        "stage3_merge_manifest.json",
        "skills",
    ],
    "G3V": [
    ...
    "G5": [
        ...
        "results/<approved-run-id>.prompt_render_manifest.json",
        "trace2skill_targets.png",
        "closeout_audit.json",
    ],
    "G6": [
        "denominator-labeled result JSONL rows",
        "complete rendered prompt manifests",
        "closeout_audit.json",
    ],
}
