...
- `check_trace2skill_importer_fixture.py`: no-spend ARA checker for the official-eval importer fixture; verifies positive fixture import rows carry runbook/approval/prompt-artifact provenance and refusal paths reject missing prompt artifacts, missing stage ids, missing approval evidence, and accidental full-paper reproduction labels.
