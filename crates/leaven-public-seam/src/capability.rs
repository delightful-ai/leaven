...
use grant_policy::CapabilityConstraintValue;
pub use grant_policy::{
    CapabilityGrantConstraints, CapabilityGrantLimits, CapabilityGrantResource,
};
pub use registry::CapabilityRegistry;
pub use request::{CapabilityDenial, CapabilityDenialKind, CapabilityGrantRequest};
use subject::CapabilitySubject;
...
impl Grant {
    ...
    pub(crate) fn optional_constraint_bool(&self, key: &str) -> Option<bool> {
        self.constraints.optional_bool(key)
    }

    pub(crate) fn constraint_string_set(&self, key: &str) -> BTreeSet<String> {
        self.constraints.string_set(key)
    }
