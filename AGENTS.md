...
- `crates/leaven-lm*`, `crates/leaven-agent*`, `crates/leaven-agentic`, `crates/leaven-agentic-*`: LLM/provider runtime surfaces, generic agentic stage adapters, and shape-specific agentic adapter helpers; these stay outside cold and engine crates.
