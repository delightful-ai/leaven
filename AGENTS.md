...
- `crates/leaven-lm*`, `crates/leaven-agent*`, `crates/leaven-agentic`: LLM/provider and agent runtime surfaces and adapters; these stay outside cold and engine crates.
