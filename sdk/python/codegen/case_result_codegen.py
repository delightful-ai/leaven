"""Render generated msgspec case result records for the private seam wire layer."""


def render_case_results() -> str:
    return '''"""Generated typed public-seam case result records.
