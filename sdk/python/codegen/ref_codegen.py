...
type ExtensionJsonPayload = WireJsonLiteralDepth8
type GraphEventFilterPayload = dict[str, WireJsonLiteralDepth7]
type PlanLiteralValue = WireJsonLiteralDepth8
...
REF_EXPORTS = (
    "ArtifactSelector ArtifactSelectorJsonPointer AssessmentRef AssessmentRefRecord AssessmentsSubmittedEventPayload BlobRef "
    "CandidateCostScope CandidateRef CandidateRefRecord CaseInputField CaseInputPayload CaseReadInputValue CaseReadMetadataValue CaseReadTargetValue CaseRef CaseRefRecord CostDimension CostScope "
    ...
    "GraphEventFilterPayload InfoRef MetadataValue ProposalBatchAppliedEventPayload ProposalBatchRef ProposalBatchRefRecord ProposalBatchSubmittedEventPayload "
...
__all__ = (  # noqa: PLE0605, SIM905
    "{REF_EXPORTS} "
    "AssessmentPreferenceValue AssessmentRankingValue AssessmentTargetValue DataClassSet ExtensionJsonPayload MetadataBag OutputJsonValue PlanLiteralValue WireJsonField WireJsonLeafArray WireJsonLeafObject WireJsonLiteralDepth0 WireJsonLiteralDepth1 WireJsonLiteralDepth2 WireJsonLiteralDepth3 WireJsonLiteralDepth4 WireJsonLiteralDepth5 WireJsonLiteralDepth6 WireJsonLiteralDepth7 WireJsonLiteralDepth8 WireJsonObject WireJsonScalar WireJsonSchema WireJsonSchemaObject WireJsonSchemaTypeName WireJsonValue"
).split()
'''
