...
REF_EXPORTS = (
    ...
    "CandidateCostScope CandidateRef CandidateRefRecord CaseInputField CaseInputPayload CaseRef CaseRefRecord CostDimension CostScope "
...
__all__ = (  # noqa: PLE0605, SIM905
    "{REF_EXPORTS} "
    "DataClassSet MetadataBag WireJsonAssessmentPreference WireJsonAssessmentRanking WireJsonAssessmentTarget WireJsonCaseReadInput WireJsonCaseReadMetadata WireJsonCaseReadTarget WireJsonExtensionPayload WireJsonField WireJsonGraphEventFilter WireJsonLeafArray WireJsonLeafObject WireJsonLiteralDepth0 WireJsonLiteralDepth1 WireJsonLiteralDepth2 WireJsonLiteralDepth3 WireJsonLiteralDepth4 WireJsonLiteralDepth5 WireJsonLiteralDepth6 WireJsonLiteralDepth7 WireJsonLiteralDepth8 WireJsonLiteralValue WireJsonObject WireJsonOutputValue WireJsonScalar WireJsonSchema WireJsonSchemaObject WireJsonSchemaTypeName WireJsonValue"
).split()
'''
